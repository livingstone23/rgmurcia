...
export default function AddRestaurantForm(props) {
    ...
    const addRestaurant = () => {
        if(!restaurantName || !restaurantAddress  || !restaurantDescription){
            ...
            toastRef.current.show("El restaurante tiene que tener al menos una foto", 1500);
            ...
            uploadImageStorage(imagesSelected).then(arrayImages => {
                ...
                .catch(() => {
                    setIsLoading(false);
                    toastRef.current.show("Error al subir el restaurante, intentelo mas tarde", 2500);
                });
            });
        }
    };
...
function UploadImage(props) {
    ...
    const imageSelect = async () => {
        ...
        if(resultPermissionCamera=== "denied" ){
            toastRef.current.show("Es necesario aceptar los permisos de la galeria, si los has rechazado tienes que ir a ajustes y activarlos manualmente",2500);
        } else {
            ...
            if(result.cancelled) {
                toastRef.current.show(
                    "Has cerrado la galeria sin seleccionar ninguna imagen", 2500
                );
            } else {
    ...
    const removeImage = image => {
        ...
        Alert.alert(
            ...
            [
                ...
                {
                    text: "Eliminar",
                    //Si la url pasada es diferente a la mostrada, de lo contrario no la añade
