...
export default function ChangePasswordForm(props) {
        ...
        if(!password || !newPassword || !newPasswordRepeat ) {
            ...
            if(newPassword !== newPasswordRepeat) {
                setError({
                    ...
                    newPasswordRepeat: "Las nuevas nuevas contraseñas tiene que ser iguales"
                });
            } else {
                ...
                .catch(() => {
                    setError({password: "El constraseña no es correcta." });
                    setIsLoading(false);
                });
    ...
    return (
        ...
        <Input 
            placeholder="Repetir la nueva constraseña"
            containerStyle={styles.input}
            password={true}
